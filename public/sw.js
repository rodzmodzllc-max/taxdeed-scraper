...
const CACHE = "tdw-shell-v33"; // bumped for Phase 63's TX offline shell fix (tx.html/tx-counties.svg now precached, offline navigate fallback is now path-aware)
const SHELL = [
  "/",
  "/index.html",
